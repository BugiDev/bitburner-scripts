 ...
 * @param silent
 */
function autoUpgradeHacknet(ns: NS, silent = false) {
 ...
 * @param nodeCount
 */
function getLeastExpensiveLevel(ns: NS, nodeCount: number) {
 ...
 * @param nodeCount
 */
function getLeastExpensiveRAM(ns: NS, nodeCount: number) {
  let leastExpensiveCost = Infinity;
  let leastExpensiveIndex = 0;
  for (let i = 0; i < nodeCount; i++) {
 ...
 * @param nodeCount
 */
function getLeastExpensiveCore(ns: NS, nodeCount: number) {
  let leastExpensiveCost = Infinity;
  let leastExpensiveIndex = 0;
  for (let i = 0; i < nodeCount; i++) {
